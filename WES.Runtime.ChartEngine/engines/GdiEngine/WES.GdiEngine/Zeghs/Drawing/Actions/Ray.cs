...
namespace Zeghs.Drawing.Actions {
	internal sealed class Ray : IAction, IDrawable {
		private static string __sName = "Ray";
		private static string __sComment = "Ray Line";
		private static Image[] __cImages = new Image[] { Zeghs.Properties.Resources.Ray };
		...
		public void DrawObject(Layer layer, DrawObject item) {
			...
			bool bDraw = Boundary.RayFix(ref cPoints[0], ref cPoints[1], new Rectangle4(layer.LayerRectangleWithoutAxisY));
