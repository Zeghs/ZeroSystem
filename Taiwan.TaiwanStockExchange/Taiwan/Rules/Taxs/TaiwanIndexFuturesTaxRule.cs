...
namespace Taiwan.Rules.Taxs {
	[RuleProperty(ERuleType.Tax, "TaiwanIndexFuturesTaxRule", "Taiwan.Rules.Taxs.TaiwanIndexFuturesTaxRule", "(台灣指數型期貨交易稅規則)\r\n\r\n台灣指數型期貨交易稅率係由台灣期交所與金管會所制定，其稅率由台灣期貨交易所公告為準。", true)]
	public sealed class TaiwanIndexFuturesTaxRule : RuleBase, ITax, IRuleSetting {
		private double __dTaxRate = 0;

		public TaiwanIndexFuturesTaxRule() {
			ShowSetting();
		}

		public TaiwanIndexFuturesTaxRule(JToken args) {
			this.args = args;
